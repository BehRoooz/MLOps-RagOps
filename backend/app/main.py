# backend/app/main.py
"""
This module is used to run the FastAPI application.
"""


from fastapi import FastAPI
from app.core.config import settings
from app.api import health, ingest, search, chat, stats, embeddings, pdf, batch_ingest, search_rerank, metadata
